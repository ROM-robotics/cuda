...
ဥပမာ:
  Block(0, 0): blockIdx.y = 0
    ...
    - Thread(0,3): row = 0*4 + 3 = 3 ✓
    
  Block(0, 1): blockIdx.y = 1
    - Thread(0,0): row = 1*4 + 0 = 4 ✓
    - Thread(0,3): row = 1*4 + 3 = 7 ✓
```
...
ဥပမာ:
  Block(0, 0): blockIdx.x = 0
    ...
    - Thread(3,0): col = 0*4 + 3 = 3 ✓
    
  Block(1, 0): blockIdx.x = 1
    - Thread(0,0): col = 1*4 + 0 = 4 ✓
    - Thread(3,0): col = 1*4 + 3 = 7 ✓
```
